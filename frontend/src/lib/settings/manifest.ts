...
export interface SettingsEntry {
  ...
  deepLinkTo?: string;
  advanced?: boolean;
  /** For secret fields: key in the settings blob (e.g. 'binance_has_key') that is
   *  true when a value is saved. Used to show the "saved" badge when the backend
   *  intentionally returns an empty string for the raw secret. */
  configuredByPath?: string;
}
...
export const SETTINGS_SUBSECTIONS: SettingsSubsection[] = [
  ...
  { id: 'trading-credentials-binance', area: 'trading', label: 'Binance credentials', description: 'API key, API secret, and testnet toggle for Binance.' },
  { id: 'trading-credentials-kraken', area: 'trading', label: 'Kraken credentials', description: 'API key, API secret, and testnet toggle for Kraken.' },
  { id: 'trading-credentials-okx', area: 'trading', label: 'OKX credentials', description: 'API key, API secret, passphrase, and testnet toggle for OKX.' },
  { id: 'trading-credentials-coinbase', area: 'trading', label: 'Coinbase credentials', description: 'API key and API secret for Coinbase.' },
  { id: 'trading-credentials-generic-ccxt', area: 'trading', label: 'Generic CCXT credentials', description: 'Exchange ID, API key, API secret, and testnet toggle for any CCXT exchange.' },
...
export const SETTINGS_MANIFEST: SettingsEntry[] = [
  ...
  // Exchange selection
  {
    ...
    options: [
      ...
      { value: 'okx', label: 'OKX' },
      { value: 'coinbase', label: 'Coinbase' },
      { value: 'generic_ccxt', label: 'Generic CCXT' },
    ],
    area: 'trading',
  ...
  // Binance credentials
  {
    ...
    type: 'secret',
    area: 'trading',
    subsection: 'trading-credentials-binance',
  ...
  // Kraken credentials
  {
    ...
    type: 'secret',
    area: 'trading',
    subsection: 'trading-credentials-kraken',
  ...
  // OKX credentials
  {
    ...
    type: 'secret',
    area: 'trading',
    subsection: 'trading-credentials-okx',
    backendSection: 'okx',
  ...
  // Coinbase credentials
  {
    ...
    type: 'secret',
    area: 'trading',
    subsection: 'trading-credentials-coinbase',
    backendSection: 'coinbase',
  ...
  {
    id: 'generic_ccxt.exchange_id',
    label: 'Exchange ID',
    default: '',
    type: 'text',
    area: 'trading',
    subsection: 'trading-credentials-generic-ccxt',
