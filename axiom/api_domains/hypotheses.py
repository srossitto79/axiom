...
def _enqueue_generate_strategies(
    *,
    ...
    description = (
        ...
        f"   - CUSTOM CODE path: use create_custom_strategy when the mechanism uses "
        f"enrichment columns (liq_short_volume, l2_imbalance_*, ls_ratio, open_interest, "
        f"funding_rate, etc.) or needs logic no template family supports. The enrichment "
